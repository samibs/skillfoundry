...
| SKILLFOUNDRY_APPS_ROOT | `/home/redacted-user/apps` | Manual | Yes | Root directory for app scanning |
...
|------|------|--------|------|
| Technical Lead / Owner | redacted-user | Pending | |
| Security (self-review) | redacted-user | Pending | |
...
|---------|------|--------|---------|
| 1.0 | 2026-03-28 | redacted-user + PRD Architect | Initial draft |
