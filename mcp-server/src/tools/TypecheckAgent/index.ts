/**
 * TypecheckAgent tool module — self-contained MCP tool for sf_typecheck.
 */

import { TOOL_NAME, TOOL_DESCRIPTION, TOOL_TIER, INPUT_SCHEMA } from "./constants.js";
import { CATEGORY } from "./permissions.js";
import { runTypeCheck } from "./TypecheckAgent.js";
import type { ToolModule, ToolResult } from "../types.js";

const typecheckAgentModule: ToolModule = {
  name: TOOL_NAME,
...
export default typecheckAgentModule;
