...
**Evidence**: The insight extractor found `Security: hardcoded secrets` as the #1 pattern across SmartExchange, redacted-project, amudfin, circularwatch.lu, taxnavigator, and others. Session transcripts show this being flagged and "fixed" repeatedly, only to reappear in later sessions.
