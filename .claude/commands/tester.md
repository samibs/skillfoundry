...
The Shadow Risk Assessment looks like:
```
1. [HIGH] Input validation missing on POST /users — XSS vector
2. [MEDIUM] No error handling for DB connection failure
3. [LOW] Magic string "admin" hardcoded
```
