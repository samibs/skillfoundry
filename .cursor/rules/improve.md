---
description: /improve — Continuous Improvement Loop
globs:
alwaysApply: false
---
...
> **Activation**: Say "improve" or "use improve rule" in chat to activate this workflow.
...
- "use improve rule"
- "improve — run the workflow"
- "follow the improve workflow for this task"
