---
description: /hotfix — Emergency Fix Pipeline
globs:
alwaysApply: false
---
...
> **Activation**: Say "hotfix" or "use hotfix rule" in chat to activate this workflow.
...
- "use hotfix rule"
- "hotfix — run the workflow"
- "follow the hotfix workflow for this task"
