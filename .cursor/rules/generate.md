---
description: /generate — Local Secret & Artifact Generator
globs:
alwaysApply: false
---
...
> **Activation**: Say "generate" or "use generate rule" in chat to activate this workflow.
...
- "use generate rule"
- "generate — run the workflow"
- "follow the generate workflow for this task"
