---
description: /quick — Lightweight Feature Workflow
globs:
alwaysApply: false
---
...
> **Activation**: Say "quick" or "use quick rule" in chat to activate this workflow.
...
- "follow the quick workflow for this task"
