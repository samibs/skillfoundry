---
description: /verify — Verification Gate (agent-agnostic)
globs:
alwaysApply: false
---
...
> **Activation**: Say "verify" or "use verify rule" in chat to activate this workflow.
...
- "follow the verify workflow for this task"
