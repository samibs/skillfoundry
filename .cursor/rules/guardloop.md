---
description: /guardloop — Adaptive Learning Guardrail Engine
globs:
alwaysApply: false
---

# guardloop — Cursor Rule

> **Activation**: Say "guardloop" or "use guardloop rule" in chat to activate this workflow.
...
- "use guardloop rule"
- "guardloop — run the workflow"
- "follow the guardloop workflow for this task"
