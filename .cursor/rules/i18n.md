---
description: Use this agent for internationalization, localization, translation workflows, RTL support, and multi-language applications.
globs:
alwaysApply: false
---
...
> **Activation**: Say "i18n" or "use i18n rule" in chat to activate this workflow.
...
- "use i18n rule"
- "i18n — implement the authentication feature"
- "follow the i18n workflow for this task"
