---
description: /onboard — SkillFoundry First-Run Setup
globs:
alwaysApply: false
---
...
> **Activation**: Say "onboard" or "use onboard rule" in chat to activate this workflow.
...
- "use onboard rule"
- "onboard — run the workflow"
- "follow the onboard workflow for this task"
