---
description: Use this agent for GDPR compliance audits, data protection impact assessments, cookie consent validation, PII detection, data retention policy review, and privacy-by-design checks.
globs:
alwaysApply: false
---
...
> **Activation**: Say "privacy" or "use privacy rule" in chat to activate this workflow.
...
- "use privacy rule"
- "privacy — implement the authentication feature"
- "follow the privacy workflow for this task"
