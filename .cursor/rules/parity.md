---
description: /parity — Cross-Platform Skill Parity Detector
globs:
alwaysApply: false
---
...
> **Activation**: Say "parity" or "use parity rule" in chat to activate this workflow.
...
- "use parity rule"
- "parity — run the workflow"
- "follow the parity workflow for this task"
