---
description: Use this agent to validate the live deployed surface of a web application before production promotion.
globs:
alwaysApply: false
---

# web-security-check — Cursor Rule

> **Activation**: Say "web-security-check" or "use web-security-check rule" in chat to activate this workflow.
...
- "use web-security-check rule"
- "web-security-check — implement the authentication feature"
- "follow the web-security-check workflow for this task"
