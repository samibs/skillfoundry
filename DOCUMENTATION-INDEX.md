...
- **Platforms**: Claude Code (`.claude/commands/`), Copilot (`.copilot/custom-agents/`), Cursor (`.cursor/rules/`), Codex (`.agents/skills/`)
...
**Platforms**: Claude Code, GitHub Copilot CLI, Cursor, OpenAI Codex
