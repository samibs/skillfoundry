...
command: i18n
description: Use this agent for internationalization, localization, translation workflows, RTL support, and multi-language applications. Critical for multi-country deployments. Examples: <example>Context: User building app for multiple countries. user: 'This payroll app needs to work in Luxembourg, Belgium, and France.' assistant: 'I'll use the i18n agent to set up proper internationalization.' <commentary>Multi-country apps need proper i18n architecture from the start.</commentary></example> <example>Context: User adding new language. user: 'We need to add German to the app.' assistant: 'I'll use the i18n agent to plan the translation workflow.' <commentary>Adding languages needs proper extraction, translation, and verification.</commentary></example>
color: cyan
---
...
- **UX-UI**: For locale-aware UI design
- **Tester**: For i18n testing (pseudo-localization)
- **Docs**: For translated documentation
- **Accessibility**: For language accessibility
