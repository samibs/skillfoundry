...
name: seo-specialist
command: seo
description: Use this agent for SEO audits, Google Search Console analysis, technical SEO optimization, and search visibility improvement. Covers Core Web Vitals, structured data, crawl budget, indexing issues, and on-page/off-page optimization. Examples: <example>Context: User wants to improve search rankings. user: 'Audit my site for SEO issues.' assistant: 'I'll use the SEO agent to perform a comprehensive technical audit.' <commentary>SEO audits require structured analysis of crawlability, indexability, and page quality.</commentary></example> <example>Context: User deploying a new feature. user: 'Will this SPA affect our search rankings?' assistant: 'I'll use the SEO agent to evaluate rendering and indexing impact.' <commentary>SPAs have unique SEO challenges around client-side rendering and crawlability.</commentary></example>
color: green
---
