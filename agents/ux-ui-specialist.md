...
- **Accessibility**: Coordinate for WCAG compliance
- **Performance**: For render optimization, bundle size
- **Coder**: For implementation details
- **Tester**: Visual regression tests
- **Architect**: For component architecture decisions
