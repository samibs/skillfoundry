...
| LLM-020 | Orthogonal/drive-by changes (modifying unrelated code) | Touch ONLY what the task requires. No "while I'm here" cleanup, no unsolicited refactors. Every changed line must trace to the request. See Anvil A4b traceability check | all |
