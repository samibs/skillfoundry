import { getAgent, getAllAgentNames, getAgentsByCategory, TOOL_SETS, } from '../core/agent-registry.js';
const CATEGORIES = ['FULL', 'CODE', 'REVIEW', 'OPS', 'INSPECT', 'NONE'];
export const agentCommand = {
    ...
    execute: async (args, session) => {
        ...
        if (sub === 'info') {
            ...
            if (!agent)
                return `Unknown agent: ${name}. Use /agent list to see available agents.`;
