...
function operatorPrompt(displayName, role) {
...
function advisorPrompt(displayName, role, domain) {
...
// ---------------------------------------------------------------------------
const DEFAULT_PROMPT = 'You are SkillFoundry AI, a helpful coding assistant. Be concise and direct. You have access to tools for reading files, writing files, searching code, and running shell commands. Use them when needed to help the user.';
// ---------------------------------------------------------------------------
// Public API
// ---------------------------------------------------------------------------
...
export function getAgentTools(name) {
 ...
 */
export const AGENT_ARCHETYPE_MAP = {
 ...
 */
export function getAgentArchetype(name) {
