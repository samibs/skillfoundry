 ...
 */
export function persistStoryDeliverable(workDir, prdId, deliverable) {
    const log = getLogger();
 ...
 */
export function saveForgeState(workDir, state) {
    const log = getLogger();
 ...
 */
export function loadForgeState(workDir) {
    const filePath = join(workDir, STATE_FILE);
...
//# sourceMappingURL=progressive-persist.js.map