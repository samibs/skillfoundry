 ...
 */
export function deriveProject(workDir) {
 ...
 */
export function isVisibleToProject(entry, activeProject) {
    if (!entry.project || entry.project === UNIVERSAL_PROJECT)
        return true;
...
export function recall(workDir, query, maxResults = 10, options) {
