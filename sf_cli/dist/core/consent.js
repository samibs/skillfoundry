 ...
 */
export function getConsentStatus(workDir) {
 ...
 */
export function setConsent(workDir, choice) {
 ...
 */
export async function promptConsent(workDir) {
    ...
    const choice = answer.trim().toLowerCase() === 'y' ? 'opted_in' : 'opted_out';
 ...
 */
function parseTelemetrySection(content) {
 ...
 */
function extractTomlString(body, key) {
 ...
 */
function extractTomlNumber(body, key) {
 ...
 */
function removeTelemetrySection(content) {
