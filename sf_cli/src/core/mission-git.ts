 ...
 */
export function rangePatchId(workDir: string, base: string, tip: string): string | null {
...
export function commitsBetween(workDir: string, base: string, tip: string): string[] {
