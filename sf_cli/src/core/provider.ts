...
// Model capability tiers for CLI warnings and gate configuration.
// Tier 1: Full pipeline support (all gates, autonomous mode, multi-story)
// Tier 2: Individual skills + basic pipeline (most gates, simple autonomous)
// Tier 3: Individual skills only (limited gates, no pipeline)
// Tier 4: Basic tasks only (no gates, no pipeline, no tool use)
...
export function checkModelTierWarning(model: string, feature: string): string | null {
