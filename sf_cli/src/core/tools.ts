...
export const TOOL_BASH: ToolDefinition = {
  name: 'bash',
  description:
    'Execute a shell command and return stdout/stderr. Use for git operations, build commands, package management, and other terminal tasks. Commands run in the project working directory.',
  input_schema: {
    type: 'object',
    properties: {
      command: {
...
export const TOOL_READ: ToolDefinition = {
  name: 'read',
  description:
    'Read a file from the filesystem. Returns file contents with line numbers. Supports text files, and will indicate binary files. Use absolute or project-relative paths.',
  input_schema: {
    type: 'object',
    properties: {
      file_path: {
...
export const TOOL_WRITE: ToolDefinition = {
  name: 'write',
  description:
...
export const TOOL_GLOB: ToolDefinition = {
  name: 'glob',
  description:
    'Search for files matching a glob pattern. Returns matching file paths. Use patterns like "**/*.ts", "src/**/*.tsx", "*.json".',
  input_schema: {
    type: 'object',
    properties: {
      pattern: {
...
export const TOOL_GREP: ToolDefinition = {
  name: 'grep',
  description:
    'Search file contents for a regex pattern. Returns matching lines with file paths and line numbers. Supports full regex syntax.',
  input_schema: {
    type: 'object',
    properties: {
      pattern: {
