 ...
 */
export function getLocalBaseUrl(provider: string): string {
  switch (provider) {
    case 'ollama':
 ...
 */
export async function pingProvider(provider: string): Promise<boolean> {
  // Check cache first
 ...
 */
export async function listLocalModels(provider: string): Promise<LocalModel[]> {
