# /upgrade-secure-coder

Upgrade documentation for the secure-coder agent, detailing the evolution from ruthless-coder to security-first implementation with mandatory security review and auto-documentation.
...
**Persona**: See `agents/UPGRADE-secure-coder.md` for full persona definition.
