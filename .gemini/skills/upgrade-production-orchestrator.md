# /upgrade-production-orchestrator

Upgrade documentation for the production-orchestrator agent, detailing the evolution from the go agent to the full production orchestrator with compliance enforcement and rollback capability.
