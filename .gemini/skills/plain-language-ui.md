...
Use this agent whenever building, adding, or redesigning any screen, form, page, dashboard, wizard, table, or component in a compliance/fintech/regtech app (AML, KYC, VAT, payroll, audit, CSSF, tax filing), whenever the user says labels are cryptic or confusing ("I don't understand this button/field"), or whenever asked to audit, review, or fix front-end wording.
