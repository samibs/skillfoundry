...
Use this agent for GDPR compliance audits, data protection impact assessments, cookie consent validation, PII detection, data retention policy review, and privacy-by-design checks.
