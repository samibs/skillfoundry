...
**Affected**: redacted-project, taxnavigator, amudfin, regpilot, auditsuite (partial)
...
**Affected**: redacted-project, taxnavigator, TestimonialCollector
...
| **D (<5C)** | auditsuite, riskframe, SmartExchange, intrastat, aigovernance.work, luxcompliancesuite.com, testmcp_new, partown.eu, axiom.codes, FinancialRatingAI, planscan, TestimonialCollector, redacted-project, paiz, taxnavigator |
| **F (5+C)** | compliance-suite, regpilot, redacted-project |
