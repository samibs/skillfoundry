# Documentation Index - SkillFoundry Framework v5.32.0
...
**61 Agents (Core Roster) / 108 Skills** | **Hexa Platform** (Claude Code, GitHub Copilot CLI, Cursor, OpenAI Codex, Google Gemini, Grok Build) | **Auto-Remediation** | **Knowledge Exchange** | **Swarm Coordination** | **DX Tooling** | **Advanced Intelligence**
...
| **[DELIVERY-EFFICIENCY.md](docs/DELIVERY-EFFICIENCY.md)** | - | Delivery budgets, risk-based validation, evidence reuse, validation deduplication, test scopes, escalation, stop conditions |
| **[V5.32.0-RELEASE-NOTES.md](docs/V5.32.0-RELEASE-NOTES.md)** | - | What's new in v5.32.0 — AI Delivery Efficiency: delivery budgets, risk-based validation, evidence reuse, validation deduplication, measured impact, scoped tests, stop conditions |
...
### OpenAI Codex (NEW)
- **[AGENTS.md](AGENTS.md)** - Root-level Codex always-on context
- **`.agents/skills/*/SKILL.md`** - 108 Codex Skills (generated by sync engine)

### Google Gemini (NEW)
- **`.gemini/skills/*.md`** - Gemini skill documents (generated by sync engine)
...
### Centralized Dashboard (NEW v2.0.78)
...
- **Platforms**: Claude Code (`.claude/commands/`), Copilot (`.copilot/custom-agents/`), Cursor (`.cursor/rules/`), Codex (`.agents/skills/`), Gemini (`.gemini/skills/`)
...
- **Command**: `/anvil` — Manual invocation across all 4 platforms
...
**Platforms**: Claude Code, GitHub Copilot CLI, Cursor, OpenAI Codex, Google Gemini
