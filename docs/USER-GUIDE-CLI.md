...
> **v2.0.70** — Interactive terminal AI assistant with streaming, tools, quality gates, multi-provider support, structured logging, native debugger, local-first development, telemetry baseline, HTML reports, session monitoring, centralized dashboard, and consent system.
