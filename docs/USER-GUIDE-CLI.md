...
> **v2.0.17** — Interactive terminal AI assistant with streaming, tools, quality gates, multi-provider support, and local-first development.
...
*SkillFoundry CLI v2.0.17 — February 2026*
