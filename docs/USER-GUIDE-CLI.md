...
> **v2.0.40** — Interactive terminal AI assistant with streaming, tools, quality gates, multi-provider support, structured logging, native debugger, and local-first development.
