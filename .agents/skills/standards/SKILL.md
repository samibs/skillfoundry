...
name: standards
description: >-
  Use this agent when you need to evaluate code, architecture, or development practices against the NASAB framework principles and language-specific best practices.
---
