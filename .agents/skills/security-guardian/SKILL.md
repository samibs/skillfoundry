...
description: >-
  Use this agent for continuous security validation from code to runtime, including static analysis, dependency vulnerability scanning, SBOM generation, and runtime security monitoring.
---
