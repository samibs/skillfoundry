...
Agent Usage Analytics - View invocation statistics and performance trends.
...
3. **Compute and display** the analytics dashboard with totals, top agents, and recent failures.
