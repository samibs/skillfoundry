...
DevOps Specialist -- Manages git operations, CI/CD pipelines, GitHub/Azure DevOps platforms, infrastructure, backup, disaster recovery, and cleanup. The single authority on version control and production infrastructure.
