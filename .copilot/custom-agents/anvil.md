...
```
task("anvil", "run all tiers")           Run all tiers on changed files
task("anvil", "t1")                      Tier 1 only (shell checks)
task("anvil", "t1 <file>")              Tier 1 on specific file
task("anvil", "t2")                      Tier 2 (canary smoke test)
task("anvil", "t3")                      Tier 3 (self-adversarial review)
task("anvil", "t4")                      Tier 4 (scope validation)
task("anvil", "t5")                      Tier 5 (contract enforcement)
task("anvil", "t6")                      Tier 6 (shadow tester risk assessment)
```
